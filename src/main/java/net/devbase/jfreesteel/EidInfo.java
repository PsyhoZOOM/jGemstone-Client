...
public class EidInfo {
   ...
   *
   * FIXME: Use one parameterized format string to allow both "Main street 11" and "11 Main street"
   *
   * FIXME: Think about how to handle short form format with missing ENTRANCE/FLOOR label (line
   * 298).
   */
  ...
  public enum Tag {
     ...
     *
     * While mostly unique, due to the non-bulletproof number allocation scheme, has actually been
     * known to repeat for some rare individuals. The last digit is mod 11 checksum, but due the
     * same reason, there exist numbers with incorrect checksum.
     */
    ...
    /**
     * The parent's given name, the usual 'parenthood' middle name used to disambiguate similarly
     * named persons. <p> E.g. "Wiley" for some John Wiley Smith.
     */
