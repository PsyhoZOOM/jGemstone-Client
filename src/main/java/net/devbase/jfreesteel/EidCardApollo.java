 ...
 *
 * EidCardApollo implements EidCard abstract interface for reading data from the Serbian eID cards
 * based on Apollo v2.43 OS that were issued before Aug 18 2014.
 *
