 ...
 *
 * EidCardGemalto implements EidCard abstract interface for reading data from the Serbian eID cards
 * based on Gemalto MultiApp ID JavaCard that are issued after Aug 18 2014.
 *
 * You should not initialize this class directly. Use EidCard.fromCard() factory method for "direct"
 * access, or initialize a Reader class and assign the listener for the card insertion/removal
 * events. The listener will receive EidCard object when the card is inserted into the terminal.
 *
