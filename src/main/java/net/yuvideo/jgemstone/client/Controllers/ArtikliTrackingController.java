...
public class ArtikliTrackingController implements Initializable {
  ...
  public void initialize(URL location, ResourceBundle resources) {
    ...
    tblArtTracking.getSelectionModel().selectedItemProperty()
        .addListener(new ChangeListener<ArtikliTracking>() {
          @Override
          public void changed(ObservableValue<? extends ArtikliTracking> observable,
              ArtikliTracking oldValue, ArtikliTracking newValue) {
  ...
  public void setData() {
    ...
    tblArtTracking
        .setItems(FXCollections.observableArrayList(artikliTracking.getArtikliTrackingArrayList()));
