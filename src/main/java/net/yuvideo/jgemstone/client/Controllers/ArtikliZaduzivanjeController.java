...
public class ArtikliZaduzivanjeController implements Initializable {
  ...
  public void initialize(URL location, ResourceBundle resources) {
    ...
    tblMagacin.getSelectionModel().selectedItemProperty()
        .addListener(new ChangeListener<Magacin>() {
          @Override
          public void changed(ObservableValue<? extends Magacin> observable, Magacin oldValue,
              Magacin newValue) {
  ...
  public void bTraziMagacin(ActionEvent actionEvent) {
    Magacin magacin = new Magacin();
    ObservableList magacini = FXCollections
        .observableArrayList(magacin.getMagacin(tMagaccinSearch.getText(), this.client));
    tblMagacin.setItems(magacini);
  }

  public void bTraziUser(ActionEvent actionEvent) {
    Users user = new Users();
    ObservableList users = FXCollections
        .observableArrayList(user.getUsers(client, tKorisnikSearch.getText()));
  ...
  public void zaduziMagacin(ActionEvent actionEvent) {
    ...
    if (object.has("ERROR")) {
      ...
      AlertUser.info("INFO", String
          .format("%s je zaduzen sa %s %s", mag.getNaziv(), tKolicina.getText(),
              artikal.getNaziv()));
  ...
  public void zaduziKorisnika(ActionEvent actionEvent) {
    ...
    if (object.has("ERROR")) {
      ...
      AlertUser.info("INFO", String
          .format("%s je zaduzen sa %s %s", user.getIme(), tKolicina.getText(),
              artikal.getNaziv()));
      Stage stage = (Stage) bTraziMagacin.getScene().getWindow();
      stage.close();
    }
