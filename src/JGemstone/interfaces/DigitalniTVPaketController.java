...
import JGemstone.classes.digitalniTVPaket;
...
public class DigitalniTVPaketController implements Initializable {
    ...
    public void nov(ActionEvent actionEvent) {
        NewInterface novDtvInterface = new NewInterface("/JGemstone/resources/fxml/DigitalnaTVPaketEdit.fxml", "Nov Digitalni TV Paket", resources);
    ...
    public void edit(ActionEvent actionEvent) {
        NewInterface editDtvInterface = new NewInterface("/JGemstone/resources/fxml/DigitalnaTVPaketEdit.fxml", "Izmena Digitalnog TV Paketa", resources);
