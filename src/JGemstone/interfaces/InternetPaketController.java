...
import JGemstone.classes.InternetPaketi;
import JGemstone.classes.NewInterface;
import JGemstone.classes.NotifyUser;
...
public class InternetPaketController implements Initializable {
    ...
    public void pNovAction(ActionEvent actionEvent) {
        NewInterface internetPaketEditInterface = new NewInterface("/JGemstone/resources/fxml/InternetPaketEdit.fxml", "Nov Internet Paket", resource);
    ...
    public void bPromeni(ActionEvent actionEvent) {
        ...
        NewInterface internetPaketEditInterface = new NewInterface("/JGemstone/resources/fxml/InternetPaketEdit.fxml", "Izmena Internet Paketa", resource);
        InternetPaketEditController internetPaketEditController = internetPaketEditInterface.getLoader().getController();
        internetPaketEditController.client = this.client;
